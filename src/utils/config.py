...
if TESTING:
    ...
    SBSIP_CLIENT_ID = os.getenv('SBSIP_PSAG_CLIENT_ID_TEST', '').strip()
    SBSIP_CLIENT_SECRET = os.getenv('SBSIP_PSAG_CLIENT_SECRET_TEST', '').strip()
else:
    ...
    SBSIP_CLIENT_ID = os.getenv('SBSIP_PSAG_CLIENT_ID', '').strip()
    SBSIP_CLIENT_SECRET = os.getenv('SBSIP_PSAG_CLIENT_SECRET', '').strip()
